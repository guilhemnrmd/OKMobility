...
window.BRAND = {
    ...
    fallbackAgencies: [
        { id: 'agency_01', label: 'MobilityOS Agency 1' },
        { id: 'agency_02', label: 'MobilityOS Agency 2' },
    ],
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Page title: replace "MobilityOS" if present, otherwise prepend brand name
    if (document.title.includes('MobilityOS')) {
        document.title = document.title.replace(/MobilityOS/g, B.name);
    }
